                    ...
                    methods: {
                        ...
                        drawWater: function(t, e) {
                            for (var i = t, s = t + e, n = [], a = (this.$store.state.userinfo || {}).name, o = this.scale, r = function(t, e) {
                                    var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "ͼ����Ҫ��";
                                    if (!(e > s - 100 * o)) {
                                        var a = "".concat(i, "\r\nwww.ryqxc.com"),
                                    ...
                                    for (;;) switch (t.prev = t.next) {
                                        ...
                                        case 13:
                                            if (b = t.sent, S = Object(r.a)(b, 2), T = S[0], k = S[1], T.scale(o / T.width), T.set({
                                                    left: 0,
                                                    top: 0
                                                }), h.push(T), D = 68 * a, "www.ryqxc.com ���ǲ�+������", M = new c.fabric.Textbox("www.ryqxc.com ���ǲ�+������", {
                                                    fontFamily: "sans-serif",
                                                    fontSize: 12 * a,
                                                    fill: "#159bff",
                                                    textAlign: "center",
                                                    ...
                                                    left: 100 * a,
                                                    top: D
                                                }), "ɨ���ά�룬����ͼ����Ҫ������ע��", (B = new c.fabric.Textbox("ɨ���ά�룬����ͼ����Ҫ������ע��", {
                                                    fontFamily: "sans-serif",
                                                    fontSize: 12 * a,
                                                    fill: "#333",
                                                    textAlign: "center",
                                            ...
                                            j = new c.fabric.Text(n.title, {
                                                ...
                                                h.push(i)
                                            })("��Ӧ��", 135), A("������", 190), A("��ɱ��", 245), A("�����", 300), t.next = 66;
                                            break;
                                        case 38:
                                            if (!d) {
                                                t.next = 63;
                                        ...
                                        case 61:
                                            ...
                                            break;
                                        case 63:
                                            "δ��¼�������û�", R = new c.fabric.Textbox("δ��¼�������û�", {
                                                fontFamily: "sans-serif",
                                                fontSize: 14 * a,
                                                fontWeight: "bold",
                                                fill: "#333",
                            ...
                            var t = Object(n.a)(regeneratorRuntime.mark((function t(e) {
                                ...
                                return regeneratorRuntime.wrap((function(t) {
                                    for (;;) switch (t.prev = t.next) {
                                        ...
                                        case 16:
                                            return this.$msgbox.show("����ͼƬʧ��"), t.abrupt("return", "");
                                        case 18:
                                        case "end":
                                            return t.stop()
                                    }
